...
![Architecture](https://img.shields.io/badge/arch-x64-orange)
...
- For production use, sign the driver via [Microsoft Attestation Signing](https://learn.microsoft.com/en-us/windows-hardware/drivers/dashboard/code-signing-attestation)
...
1. Go to [Microsoft Hardware Dev Center](https://partner.microsoft.com/dashboard/hardware)
2. Submit the driver for **Attestation Signing** (free, no WHQL testing required)
3. Users won't need test signing mode enabled
